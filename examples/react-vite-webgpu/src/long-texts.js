...
(3) 제1항 및 제2항의 규정에 따라 보호되는 외국인(대한민국 내에 상시 거주하는 외국인 및 무국적자를 제외한다)의 저작물이라도 그 외국에서 대한민국 국민의 저작물을 보호하지 아니하는 경우에는 그에 상응하게 조약 및 이 법에 따른 보호를 제한할 수 있다.`,
...
EXAMPLES.sort((a, b) => a.length - b.length);
